...
puts "=== CONTAGEM POR MÓDULO ==="

dict for {mod contagens} $relatorio {
    puts "\nMódulo: $mod"
    
    set prims [dict get $contagens "qtd_primitivas"]
    set subs  [dict get $contagens "qtd_submodulos"]
    
    puts "  - Primitivas instanciadas: $prims"
    puts "  - Submódulos instanciados: $subs"
}